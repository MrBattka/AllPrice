...
export const returnIDOtherBrand = (name) => {
  if (name.indexOf("rog ally 16/256 white") !== -1) {
    ...
    name.indexOf("rog phone 9 12/256") !== -1 &&
    ...
    name.indexOf("rog phone 9 16/512") !== -1 &&
    name.indexOf("black") !== -1
  ) {
    return 37808;
  } else if (
    ...
    name.indexOf("rog phone 9 pro 16/512") !== -1 &&
    name.indexOf("black") !== -1
  ) {
    return 37795;
  } else if (
    name.indexOf("rog phone 9 pro 24/1tb") !== -1 &&
    name.indexOf("black") !== -1
  ) {
    return 37814;
...
name.indexOf("oneplus ace 5 pro") !== -1 &&
  ...
  name.indexOf("white") !== -1) {
    ...
    name.indexOf("pixel 9") !== -1 &&
    name.indexOf("128") !== -1 &&
    (name.indexOf("peony") !== -1 || name.indexOf("pink") !== -1 || name.indexOf("rose") !== -1)
  ) {
    return 36693;
  } else if (
    name.indexOf("xl") === -1 && 
