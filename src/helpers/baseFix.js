export const baseFix = (el) => {
  return el[0] !== "(" &&
    ...
    el.Модификация?.indexOf("16E 128") != -1 ||
    el.Модификация?.indexOf("16E 256") != -1 ||
    el.Модификация?.indexOf("16E 512") != -1 ||
    el.Модификация?.indexOf("16 Pro Max") != -1 ||
    el.Модификация?.indexOf("16 Pro 256") != -1 ||
    el.Модификация?.indexOf("16 Pro 512") != -1 ||
    el.Модификация?.indexOf("16 Pro 1") != -1 ||
    el.Модификация?.indexOf("16 Plus 128") != -1 ||
    el.Модификация?.indexOf("16 Plus 256") != -1 ||
    el.Модификация?.indexOf("16 Plus 512") != -1 ||
    el.Модификация?.indexOf("15 128") != -1 ||
    el.Модификация?.indexOf("15 256") != -1 ||
    el.Модификация?.indexOf("15 512") != -1 ||
    el.Модификация?.indexOf("15 Pro Max") != -1 ||
    el.Модификация?.indexOf("15 Pro 256") != -1 ||
    el.Модификация?.indexOf("15 Pro 512") != -1 ||
    el.Модификация?.indexOf("15 Pro 1") != -1 ||
    el.Модификация?.indexOf("15 Plus 128") != -1 ||
    el.Модификация?.indexOf("15 Plus 256") != -1 ||
    el.Модификация?.indexOf("15 Plus 512") != -1 ||
    el.Модификация?.indexOf("14 128") != -1 ||
    el.Модификация?.indexOf("14 256") != -1 ||
    el.Модификация?.indexOf("14 512") != -1 ||
    el.Модификация?.indexOf("14 Pro 256") != -1 ||
    el.Модификация?.indexOf("14 Pro 512") != -1 ||
    el.Модификация?.indexOf("14 Pro 1") != -1 ||
    el.Модификация?.indexOf("14 Plus 128") != -1 ||
    el.Модификация?.indexOf("14 Plus 256") != -1 ||
    el.Модификация?.indexOf("14 Pro Max") != -1 ||
    el.Модификация?.indexOf("14 Plus 512") != -1)
    ? el.Модификация?.indexOf("🇺🇸") == -1
    : el.Модификация &&
...
export const baseFixHi = (el) => {
  return el.name.indexOf("🇺🇸") != -1 &&
    (el.name.indexOf("16 128") != -1 ||
      ...
      el.name.indexOf("14 Pro 1") != -1 ||
      el.name.indexOf("14 Plus 128") != -1 ||
      el.name.indexOf("14 Plus 256") != -1 ||
      el.name.indexOf("14 Pro Max") != -1 ||
      el.name.indexOf("14 Plus 512") != -1)
    ? el.name.indexOf("🇺🇸") == -1
    : el.name &&
...
export const baseFixMiHonor = (el) => {
  ...
  return toLowerCase?.indexOf("🇺🇸") != -1 &&
    ...
    toLowerCase.indexOf("16e 128") != -1 ||
    toLowerCase.indexOf("16e 256") != -1 ||
    toLowerCase.indexOf("16e 512") != -1 ||
    toLowerCase.indexOf("16 pro max") != -1 ||
    toLowerCase.indexOf("16 pro 256") != -1 ||
    toLowerCase.indexOf("16 pro 512") != -1 ||
    toLowerCase.indexOf("16 pro 1") != -1 ||
    toLowerCase.indexOf("16 plus 128") != -1 ||
    toLowerCase.indexOf("16 plus 256") != -1 ||
    toLowerCase.indexOf("16 plus 512") != -1 ||
    toLowerCase.indexOf("15 128") != -1 ||
    toLowerCase.indexOf("15 256") != -1 ||
    toLowerCase.indexOf("15 512") != -1 ||
    toLowerCase.indexOf("15 pro max") != -1 ||
    toLowerCase.indexOf("15 pro 256") != -1 ||
    toLowerCase.indexOf("15 pro 512") != -1 ||
    ...
    toLowerCase.indexOf("14 512") != -1 ||
    toLowerCase.indexOf("14 pro 256") != -1 ||
    toLowerCase.indexOf("14 pro 512") != -1 ||
    toLowerCase.indexOf("14 pro 1") != -1 ||
    toLowerCase.indexOf("14 plus 128") != -1 ||
    toLowerCase.indexOf("14 plus 256") != -1 ||
    toLowerCase.indexOf("14 pro max") != -1 ||
    toLowerCase.indexOf("14 plus 512") != -1)
...
export const baseFixL27 = (el) => {
  ...
  return toLowerCase?.indexOf("🇺🇸") != -1 &&
    ...
    toLowerCase.indexOf("14 pro max") != -1 ||
    toLowerCase.indexOf("14 plus 512") != -1 ||
    toLowerCase.indexOf("16128") != -1 ||
    toLowerCase.indexOf("16256") != -1 ||
    toLowerCase.indexOf("16512") != -1 ||
    toLowerCase.indexOf("16e128") != -1 ||
    toLowerCase.indexOf("16e256") != -1 ||
    toLowerCase.indexOf("16e512") != -1 ||
    toLowerCase.indexOf("16pro max") != -1 ||
    toLowerCase.indexOf("16pro 256") != -1 ||
    toLowerCase.indexOf("16pro 512") != -1 ||
    toLowerCase.indexOf("16pro 1") != -1 ||
    toLowerCase.indexOf("16plus 128") != -1 ||
    toLowerCase.indexOf("16plus 256") != -1 ||
    toLowerCase.indexOf("16plus 512") != -1 ||
    toLowerCase.indexOf("15128") != -1 ||
    toLowerCase.indexOf("15256") != -1 ||
    toLowerCase.indexOf("15512") != -1 ||
    toLowerCase.indexOf("15pro max") != -1 ||
    toLowerCase.indexOf("15pro 256") != -1 ||
    toLowerCase.indexOf("15pro 512") != -1 ||
    toLowerCase.indexOf("15pro 1") != -1 ||
    toLowerCase.indexOf("15plus 128") != -1 ||
    toLowerCase.indexOf("15plus 256") != -1 ||
    toLowerCase.indexOf("15plus 512") != -1 ||
    toLowerCase.indexOf("14128") != -1 ||
    toLowerCase.indexOf("14256") != -1 ||
    toLowerCase.indexOf("14512") != -1 ||
    toLowerCase.indexOf("14pro 256") != -1 ||
    toLowerCase.indexOf("14pro 512") != -1 ||
    toLowerCase.indexOf("14pro 1") != -1 ||
    toLowerCase.indexOf("14plus 128") != -1 ||
    toLowerCase.indexOf("14plus 256") != -1 ||
    toLowerCase.indexOf("14pro max") != -1 ||
    toLowerCase.indexOf("14plus 512") != -1)
    ? toLowerCase?.indexOf("🇺🇸") == -1
    : toLowerCase &&
      toLowerCase?.indexOf("airpods") != -1 &&
      (toLowerCase?.indexOf("left") != -1 ||
