...
export const returnIDOtherBrand2 = (name) => {
  ...
  if (name.indexOf("xbox") !== -1 && name.indexOf(" x ") !== -1) {
    ...
    name.indexOf("nintendo switch 2") !== -1 &&
    ...
    (name.indexOf("nintendo") !== -1 || name.indexOf("switch") !== -1) &&
    name.indexOf("oled") !== -1 &&
    name.indexOf("neon") !== -1
  ) {
    return 27654;
    ...
    (name.indexOf("nintendo") !== -1 || name.indexOf("switch") !== -1) &&
    name.indexOf("oled") !== -1 &&
    (name.indexOf("pokemon") !== -1 || name.indexOf("violet") !== -1)
  ) {
    return 27656;
  } else if (
    (name.indexOf("nintendo") !== -1 || name.indexOf("switch") !== -1) &&
    name.indexOf("oled") !== -1 &&
    name.indexOf("splatoon") !== -1
  ) {
    return 27655;
  } else if (
    (name.indexOf("nintendo") !== -1 || name.indexOf("switch") !== -1) &&
    ...
    name.indexOf("xperia 10 vii ") !== -1 &&
    name.indexOf("8/128") !== -1 &&
    name.indexOf("charcoal") !== -1
  ) {
    return 41014;
  } else if (
    name.indexOf("xperia 10 vii ") !== -1 &&
    ...
    (name.indexOf("redmagic 10s pro+") != -1 ||
      name.indexOf("redmagic 10s pro plus") != -1 ||
      name.indexOf("redmagic 10s pro +") != -1 ||
      name.indexOf("red magic 10s pro+") != -1 ||
      name.indexOf("red magic 10s pro plus") != -1 ||
      name.indexOf("red magic 10s pro +") != -1) &&
    ...
    return 20278;
  } else if (name.indexOf("jbl charge 5 gray") !== -1) {
    return 20285;
