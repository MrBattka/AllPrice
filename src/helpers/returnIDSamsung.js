...
//   } else if (
//     name.indexOf("a16 4/128") !== -1 &&
//     (name.indexOf("green") !== -1 || name.indexOf("mint") !== -1) &&
//     name.indexOf("5g") === -1
//   ) {
//     return 37888;
//   } else if (
...
//     name.indexOf("s25 edge") != -1 &&
//     name.indexOf("12/256") != -1 &&
//     (name.indexOf(" blue") != -1 || name.indexOf("navy") != -1)
//   ) {
//     return 39208;
//   } else if (
//     name.indexOf("s25 edge") != -1 &&
...
//     name.indexOf("z flip 6") !== -1 &&
//     name.indexOf("12/256") !== -1 &&
//     (name.indexOf("silver") !== -1 || name.indexOf("gray") !== -1)
//   ) {
//     return 36515;
//   } else if (
//     name.indexOf("z flip 6") !== -1 &&
...
//     return 38212;
//   } else if (name.indexOf("watch fe 40 silver") !== -1) {
//     return 38214;
//   } else if (name.indexOf("watch fe 40 pink") !== -1) {
//     return 38213;
...
//     return 20543;
//   } else if (
//     name.indexOf("watch 5 pro 45 black") !== -1 ||
//     name.indexOf("watch 5 pro 45 graphite") !== -1
//   ) {
//     return 27921;
//   } else if (name.indexOf("watch 5 pro 45 grey") !== -1) {
//     return 27917;
//   } else if (
//     name.indexOf("watch 6 40 graphite") !== -1 ||
//     name.indexOf("watch 6 40 black") !== -1
//   ) {
//     return 27921;
//   } else if (name.indexOf("watch 6 40 gold") !== -1) {
//     return 27922;
//   } else if (
//     name.indexOf("watch 6 44 graphite") !== -1 ||
//     name.indexOf("watch 6 44 black") !== -1
//   ) {
//     return 27923;
//   } else if (name.indexOf("watch 6 44 silver") !== -1) {
//     return 27924;
//   } else if (
...
//     // galaxy Buds
//   } else if (
//     name.indexOf("galaxy buds 2 pro graphite") !== -1 ||
//     name.indexOf("galaxy buds pro 2 graphite") !== -1 ||
//     name.indexOf("galaxy buds 2 pro black") !== -1
//   ) {
//     return 27358;
//   } else if (
//     name.indexOf("galaxy buds 2 pro purple") !== -1 ||
//     name.indexOf("galaxy buds pro 2 purple") !== -1
//   ) {
//     return 27360;
//   } else if (
//     name.indexOf("galaxy buds 2 pro white") !== -1 ||
//     name.indexOf("galaxy buds pro 2 white") !== -1
//   ) {
//     return 27359;
//   } else if (name.indexOf("galaxy buds 2") !== -1 && name.indexOf("black") !== -1) {
//     return 26585;
//   } else if (name.indexOf("galaxy buds 2") !== -1 && name.indexOf("graphite") !== -1) {
//     return 20560;
//   } else if (name.indexOf("galaxy buds 2") !== -1 && name.indexOf("lavender") !== -1) {
//     return 20564;
//   } else if (name.indexOf("galaxy buds 2") !== -1 && name.indexOf("olive") !== -1) {
//     return 20563;
//   } else if (name.indexOf("galaxy buds 2") !== -1 && name.indexOf("white") !== -1) {
//     return 20562;
//   } else if (name.indexOf("galaxy buds 3 white") !== -1) {
//     return 36498;
//   } else if (name.indexOf("galaxy buds 3 silver") !== -1) {
//     return 36532;
//   } else if (name.indexOf("galaxy buds 3 pro white") !== -1) {
//     return 38004;
//   } else if (name.indexOf("galaxy buds 3 pro silver") !== -1) {
//     return 38019;
//   } else if (
//     name.indexOf("galaxy buds fe") !== -1 &&
//     (name.indexOf("graphite") !== -1 || name.indexOf("black") !== -1)
//   ) {
//     return 35689;
//   } else if (name.indexOf("galaxy buds fe") !== -1 && name.indexOf("white") !== -1) {
//     return 37800;
//   } else if (name.indexOf("galaxy buds pro") !== -1 && name.indexOf("black") !== -1) {
//     return 19098;
//   } else if (name.indexOf("galaxy buds pro") !== -1 && name.indexOf("silver") !== -1) {
//     return 19099;
//   } else if (name.indexOf("galaxy buds pro") !== -1 && name.indexOf("violet") !== -1) {
//     return 19097;
//   } else if (name.indexOf("galaxy buds pro") !== -1 && name.indexOf("white") !== -1) {
//     return 26586;
//   } else if (name.indexOf("galaxy buds core") !== -1 && name.indexOf("white") !== -1) {
//     return 40600;
//   } else if (name.indexOf("galaxy buds core") !== -1 && name.indexOf("black") !== -1) {
//     return 40602;
//   } else if (name.indexOf("m06 4/128") !== -1 && name.indexOf("black") !== -1) {
//     return 39892;
//   } else if (name.indexOf("m06 4/128") !== -1 && name.indexOf("green") !== -1) {
//     return 39975;
//   } else if (name.indexOf("m06 4/64") !== -1 && name.indexOf("black") !== -1) {
//     return 39983;
//   } else if (name.indexOf("m06 4/64") !== -1 && name.indexOf("green") !== -1) {
//     return 39984;
//   } else if (name.indexOf("m06 6/128") !== -1 && name.indexOf("black") !== -1) {
//     return 39978;
//   } else if (name.indexOf("m06 6/128") !== -1 && name.indexOf("green") !== -1) {
//     return 39979;
//   } else if (name.indexOf("m16 4/128") !== -1 && name.indexOf("pink") !== -1) {
//     return 39990;
//   } else if (name.indexOf("m16 4/128") !== -1 && name.indexOf("green") !== -1) {
//     return 39993;
//   } else if (name.indexOf("m16 4/128") !== -1 && name.indexOf("black") !== -1) {
//     return 39894;
//   } else if (name.indexOf("m16 6/128") !== -1 && name.indexOf("pink") !== -1) {
//     return 39999;
//   } else if (name.indexOf("m16 6/128") !== -1 && name.indexOf("green") !== -1) {
//     return 40000;
//   } else if (name.indexOf("m16 6/128") !== -1 && name.indexOf("black") !== -1) {
//     return 40001;
//   } else if (name.indexOf("m16 8/128") !== -1 && name.indexOf("pink") !== -1) {
//     return 40007;
//   } else if (name.indexOf("m16 8/128") !== -1 && name.indexOf("green") !== -1) {
//     return 40008;
//   } else if (name.indexOf("m16 8/128") !== -1 && name.indexOf("black") !== -1) {
//     return 40009;
//   } else if (name.indexOf("m16 8/256") !== -1 && name.indexOf("pink") !== -1) {
//     return 40013;
//   } else if (name.indexOf("m16 8/256") !== -1 && name.indexOf("green") !== -1) {
//     return 40014;
//   } else if (name.indexOf("m16 8/256") !== -1 && name.indexOf("black") !== -1) {
//     return 40015;
//   } else if (
//     name.indexOf("m36 6/128") !== -1 &&
//     name.indexOf("orange") !== -1
//   ) {
//     return 40024;
//   } else if (name.indexOf("m36 6/128") !== -1 && name.indexOf("green") !== -1) {
//     return 40025;
//   } else if (name.indexOf("m36 6/128") !== -1 && name.indexOf("black") !== -1) {
//     return 39896;
//   } else if (
//     name.indexOf("m36 8/128") !== -1 &&
//     name.indexOf("orange") !== -1
//   ) {
//     return 40023;
//   } else if (name.indexOf("m36 8/128") !== -1 && name.indexOf("green") !== -1) {
//     return 40026;
//   } else if (name.indexOf("m36 8/128") !== -1 && name.indexOf("black") !== -1) {
//     return 40020;
//   } else if (
//     name.indexOf("m36 8/256") !== -1 &&
//     name.indexOf("orange") !== -1
//   ) {
//     return 40022;
//   } else if (name.indexOf("m36 8/256") !== -1 && name.indexOf("green") !== -1) {
//     return 40027;
//   } else if (name.indexOf("m36 8/256") !== -1 && name.indexOf("black") !== -1) {
//     return 40021;
//   } else if (
//     name.indexOf("watch 8") !== -1 &&
//     name.indexOf("classic") !== -1 &&
//     name.indexOf("lte") !== -1 &&
//     name.indexOf("46") !== -1 &&
//     name.indexOf("black") !== -1
//   ) {
