...
export const returnIDSamsung = (name) => {
  if (
    name.indexOf("a05 4/128 blue/black") != -1 ||
    name.indexOf("a05 4/128 black") != -1 ||
    name.indexOf("a15 4/128 dark") != -1
  ) {
    return 30948;
  } else if (
    name.indexOf("a05 4/128 light green") != -1 ||
    name.indexOf("a05 4/128 green") != -1
  ) {
    return 30949;
  } else if (name.indexOf("a05 4/128 silver") != -1) {
    return 30950;
  } else if (
    name.indexOf("a05 4/64 blue/black") != -1 ||
    name.indexOf("a05 4/64 black") != -1 ||
    name.indexOf("a15 4/64 dark") != -1
  ) {
    return 31006;
  } else if (
    name.indexOf("a05 4/64 light green") != -1 ||
    name.indexOf("a05 4/64 green") != -1
  ) {
    return 31007;
  } else if (name.indexOf("a05 4/64 silver") != -1) {
    return 31008;
  } else if (
    name.indexOf("a05 6/128 blue/black") != -1 ||
    name.indexOf("a05 6/128 black") != -1 ||
    name.indexOf("a05 6/128 dark") != -1
  ) {
    return 30135;
  } else if (
    name.indexOf("a05 6/128 light green") != -1 ||
    name.indexOf("a05 6/128 green") != -1
  ) {
    return 30137;
  } else if (name.indexOf("a05 6/128 silver") != -1) {
    return 30136;
  } else if (
    name.indexOf("a05s 4/128 blue/black") != -1 ||
    name.indexOf("a05s 4/128 black") != -1 ||
    name.indexOf("a05s 4/128 dark") != -1
  ) {
    return 30901;
  } else if (
    name.indexOf("a05s 4/128 light green") != -1 ||
    name.indexOf("a05s 4/128 green") != -1
  ) {
    return 30902;
  } else if (name.indexOf("a05s 4/128 silver") != -1) {
    return 30903;
  } else if (
    name.indexOf("a05s 4/128 light violet") != -1 ||
    name.indexOf("a05s 4/128 violet") != -1
  ) {
    return 30904;
  } else if (
    name.indexOf("a05s 4/64 blue/black") != -1 ||
    name.indexOf("a05s 4/64 black") != -1 ||
    name.indexOf("a05s 4/64 dark") != -1
  ) {
    return 31009;
  } else if (name.indexOf("a05s 4/64 light green") != -1) {
    return 31010;
  } else if (name.indexOf("a05s 4/64 silver") != -1) {
    return 31011;
  } else if (name.indexOf("a05s 4/64 light violet") != -1) {
    return 31012;
  } else if (
    name.indexOf("a05s 6/128 blue/black") != -1 ||
    name.indexOf("a05s 6/128 black") != -1 ||
    name.indexOf("a05s 6/128 dark") != -1
  ) {
    return 30138;
  } else if (name.indexOf("a05s 6/128 light green") != -1) {
    return 30140;
  } else if (name.indexOf("a05s 6/128 silver") != -1) {
    return 30139;
  } else if (name.indexOf("a05s 6/128 light violet") != -1) {
    return 30141;
  } else if (
    name.indexOf("a15 4/128 blue/black") != -1 ||
    name.indexOf("a15 4/128 black") != -1 ||
    name.indexOf("a15 4/128 dark") != -1
  ) {
    return 31076;
  } else if (name.indexOf("a15 4/128 light blue") != -1) {
    return 31078;
  } else if (name.indexOf("a15 4/128 blue") != -1) {
    return 31079;
  } else if (name.indexOf("a15 4/128 yellow") != -1) {
    return 35697;
  } else if (
    name.indexOf("a15 6/128 blue/black") != -1 ||
    name.indexOf("a15 6/128 black") != -1 ||
    name.indexOf("a15 6/128 dark") != -1
  ) {
    return 31080;
  } else if (name.indexOf("a15 6/128 light blue") != -1) {
    return 31082;
  } else if (name.indexOf("a15 6/128 blue") != -1) {
    return 31083;
  } else if (name.indexOf("a15 6/128 yellow") != -1) {
    return 35698;
  } else if (
    name.indexOf("a15 8/128 blue/black") != -1 ||
    name.indexOf("a15 8/128 black") != -1 ||
    name.indexOf("a15 8/128 dark") != -1
  ) {
    return 31084;
  } else if (name.indexOf("a15 8/128 light blue") != -1) {
    return 31086;
  } else if (name.indexOf("a15 8/128 blue") != -1) {
    return 31087;
  } else if (name.indexOf("a15 8/128 yellow") != -1) {
    return 35699;
  } else if (
    name.indexOf("a15 8/256 blue/black") != -1 ||
    name.indexOf("a15 8/256 black") != -1 ||
    name.indexOf("a15 8/256 dark") != -1
  ) {
    return 31088;
  } else if (name.indexOf("a15 8/256 light blue") != -1) {
    return 31090;
  } else if (name.indexOf("a15 8/256 blue") != -1) {
    return 31091;
  } else if (name.indexOf("a15 8/256 yellow") != -1) {
    return 35704;
  } else if (
    name.indexOf("a25 6/128 blue/black") != -1 ||
    name.indexOf("a25 6/128 black") != -1 ||
    name.indexOf("a25 6/128 dark") != -1
  ) {
    return 31092;
  } else if (name.indexOf("a25 6/128 blue") != -1) {
    return 31094;
  } else if (
    name.indexOf("a25 6/128 silver") != -1 ||
    name.indexOf("a25 6/128 light blue") != -1
  ) {
    return 35705;
  } else if (name.indexOf("a25 6/128 yellow") != -1) {
    return 31093;
  } else if (
    name.indexOf("a25 8/128 blue/black") != -1 ||
    name.indexOf("a25 8/128 black") != -1 ||
    name.indexOf("a15 8/128 dark") != -1
  ) {
    return 31096;
  } else if (name.indexOf("a25 8/128 blue") != -1) {
    return 31098;
  } else if (
    name.indexOf("a25 8/128 silver") != -1 ||
    name.indexOf("a25 8/128 light blue") != -1
  ) {
    return 35706;
  } else if (name.indexOf("a25 8/128 yellow") != -1) {
    return 31097;
  } else if (
    name.indexOf("a25 8/256 blue/black") != -1 ||
    name.indexOf("a25 8/256 black") != -1 ||
    name.indexOf("a15 8/256 dark") != -1
  ) {
    return 31100;
  } else if (name.indexOf("a25 8/256 blue") != -1) {
    return 31102;
  } else if (
    name.indexOf("a25 8/256 silver") != -1 ||
    name.indexOf("a25 8/256 light blue") != -1
  ) {
    return 35707;
  ...
  name.indexOf("a34 8/256 yellow") != -1) {
    ...
    return 35917;
  } else if (name.indexOf("a35 6/128 lilac") != -1) {
    return 35914;
  } else if (
  ...
  name.indexOf("a35 6/128 yellow") != -1) {
    ...
    name.indexOf("a35 8/128 blue") != -1
  ) {
    return 35918;
  } else if (name.indexOf("a35 8/128 lilac") != -1) {
    return 35915;
  } else if (
    name.indexOf("a35 8/128 navy") != -1 ||
  ...
  name.indexOf("a35 8/128 yellow") != -1) {
    ...
    name.indexOf("a35 8/256 blue") != -1
  ) {
    return 35919;
  } else if (name.indexOf("a35 8/256 lilac") != -1) {
    return 35916;
  } else if (
    name.indexOf("a35 8/256 navy") != -1 ||
  ...
  name.indexOf("a54 6/128 yellow") != -1) {
    ...
    return 27229;
  } else if (name.indexOf("a54 6/128 white") != -1) {
    return 27232;
  } else if (
    name.indexOf("a54 8/128 graphite") != -1 ||
  ...
  name.indexOf("a54 8/128 yellow") != -1) {
    ...
    return 27230;
  } else if (name.indexOf("a54 8/128 white") != -1) {
    return 27233;
  } else if (
    name.indexOf("a54 8/256 graphite") != -1 ||
  ...
  name.indexOf("a55 12/256 yellow") != -1) {
    ...
    name.indexOf("a55 12/256 navy") != -1 ||
    name.indexOf("a55 12/256 black") != -1
  ) {
    return 35925;
  } else if (
    name.indexOf("a55 8/128 iceblue") != -1 ||
  ...
  name.indexOf("a55 8/128 yellow") != -1) {
    ...
    name.indexOf("a55 8/128 navy") != -1 ||
    name.indexOf("a55 8/128 black") != -1
  ) {
    return 35923;
  } else if (
    name.indexOf("a55 8/256 iceblue") != -1 ||
  ...
  name.indexOf("a55 8/256 yellow") != -1) {
    ...
    return 26214;
  } else if (name.indexOf("s23 fe 8/128 cream") != -1) {
    return 30158;
  } else if (name.indexOf("s23 fe 8/128 graphite") != -1) {
    return 30162;
  } else if (name.indexOf("s23 fe 8/128 indigo") != -1) {
    return 30166;
  } else if (name.indexOf("s23 fe 8/128 mint") != -1) {
    return 30160;
  } else if (name.indexOf("s23 fe 8/128 purple") != -1) {
    return 30164;
  } else if (name.indexOf("s23 fe 8/128 tangerine") != -1) {
    return 30168;
  } else if (name.indexOf("s23 fe 8/256 cream") != -1) {
    return 30159;
  } else if (name.indexOf("s23 fe 8/256 graphite") != -1) {
    return 30163;
  } else if (name.indexOf("s23 fe 8/256 indigo") != -1) {
    return 30167;
  } else if (name.indexOf("s23 fe 8/256 mint") != -1) {
    return 30161;
  } else if (name.indexOf("s23 fe 8/256 purple") != -1) {
    return 30165;
    ...
    return 26267;
  } else if (name.indexOf("s23 ultra 12/1tb black") != -1) {
    return 26246;
    ...
    return 26256;
  } else if (name.indexOf("s23 ultra 12/256 lime") != -1) {
    return 26268;
    ...
    return 26257;
  } else if (name.indexOf("s23 ultra 12/512 lime") != -1) {
    return 26269;
  } else if (name.indexOf("s23 ultra 12/512 black") != -1) {
    return 26245;
  } else if (name.indexOf("s23 ultra 12/512 red") != -1) {
    return 26273;
    ...
    return 26258;
  } else if (name.indexOf("s23 ultra 8/256 lime") != -1) {
    return 26270;
  } else if (name.indexOf("s23 ultra 8/256 black") != -1) {
    return 26243;
  } else if (name.indexOf("s23 ultra 8/256 red") != -1) {
    return 26274;
    ...
    name.indexOf("s24 ultra 12/1tb titanium blue 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium blue") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/1tb titanium blue") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/1tb titanium green 🇪🇺") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium green") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/1tb titanium green") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/1tb titanium orange 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium orange") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/1tb titanium orange") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/256 titanium blue 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium blue") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/256 titanium blue") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/256 titanium green 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium green") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/256 titanium green") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/256 titanium orange 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium orange") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/256 titanium orange") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/512 titanium blue 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/512 titanium blue") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/512 titanium blue") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/512 titanium green 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/512 titanium green") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/512 titanium green") != -1 &&
      name.indexOf("🇪🇺") != -1)
    ...
    name.indexOf("s24 ultra 12/1tb titanium black 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium black") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34362;
    ...
    name.indexOf("s24 ultra 12/1tb titanium grey 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium grey") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34363;
    ...
    name.indexOf("s24 ultra 12/1tb titanium violet 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium violet") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34361;
    ...
    name.indexOf("s24 ultra 12/1tb titanium yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb titanium yellow") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34359;
    ...
    name.indexOf("s24 ultra 12/256 titanium black 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium black") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34366;
    ...
    name.indexOf("s24 ultra 12/256 titanium grey 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium grey") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34364;
    ...
    name.indexOf("s24 ultra 12/256 titanium violet 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium violet") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34355;
    ...
    name.indexOf("s24 ultra 12/256 titanium yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 titanium yellow") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34357;
    ...
    name.indexOf("s24 ultra 12/512 titanium black 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 titanium black") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34358;
    ...
    name.indexOf("s24 ultra 12/512 titanium grey 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 titanium grey") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34360;
    ...
    name.indexOf("s24 ultra 12/512 titanium violet 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 titanium violet") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34365;
    ...
    name.indexOf("s24 ultra 12/512 titanium yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 titanium yellow") != -1 &&
      name.indexOf("🇰🇿") != -1)
  ) {
    return 34356;
    ...
    name.indexOf("s24+ 12/256 green 🇦🇪") != -1 ||
    (name.indexOf("s24+ 12/256 green") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24+ 12/256 green") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35868;
  } else if (
    name.indexOf("s24+ 12/256 orange 🇦🇪") != -1 ||
    (name.indexOf("s24+ 12/256 orange") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24+ 12/256 orange") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35869;
  } else if (
    name.indexOf("s24+ 12/256 blue 🇦🇪") != -1 ||
    (name.indexOf("s24+ 12/256 blue") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24+ 12/256 blue") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35870;
  } else if (
    name.indexOf("s24+ 12/512 green 🇦🇪") != -1 ||
    (name.indexOf("s24+ 12/512 green") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24+ 12/512 green") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35871;
  } else if (
    name.indexOf("s24+ 12/512 orange 🇦🇪") != -1 ||
    (name.indexOf("s24+ 12/512 orange") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24+ 12/512 orange") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35872;
  } else if (
    name.indexOf("s24+ 12/512 blue 🇦🇪") != -1 ||
    (name.indexOf("s24+ 12/512 blue") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24+ 12/512 blue") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35873;
  } else if (
    name.indexOf("s24+ 12/256 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24+ 12/256 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34353;
  } else if (
    name.indexOf("s24+ 12/256 yellow 🇦🇪") != -1 ||
    ...
    name.indexOf("s24+ 12/256 violet 🇰🇿") != -1 ||
    (name.indexOf("s24+ 12/256 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34352;
  } else if (
    name.indexOf("s24+ 12/256 violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24+ 12/256 gray 🇰🇿") != -1 ||
    (name.indexOf("s24+ 12/256 gray") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34354;
  } else if (
    name.indexOf("s24+ 12/256 gray 🇪🇺") != -1 ||
    ...
    name.indexOf("s24+ 12/512 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24+ 12/512 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34351;
  } else if (
    name.indexOf("s24+ 12/512 yellow 🇪🇺") != -1 ||
    ...
    return 34383;
  } else if (name.indexOf("s24+ 12/512 yellow 🇦🇪") != -1) {
    return 34383;
  } else if (
    name.indexOf("s24+ 12/512 violet 🇰🇿") != -1 ||
    (name.indexOf("s24+ 12/512 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34348;
  } else if (
    name.indexOf("s24+ 12/512 violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24+ 12/512 gray 🇰🇿") != -1 ||
    (name.indexOf("s24+ 12/512 gray") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34347;
  } else if (
    name.indexOf("s24+ 12/512 gray 🇦🇪") != -1 ||
    ...
    return 30989;
  } else if (name.indexOf("s24+ 12/256 green") != -1) {
    return 35768;
  } else if (name.indexOf("s24+ 12/256 gray") != -1) {
    return 30991;
  } else if (name.indexOf("s24+ 12/256 onyx black") != -1) {
    return 30985;
  } else if (name.indexOf("s24+ 12/256 orange") != -1) {
    return 35777;
  } else if (name.indexOf("s24+ 12/256 blue") != -1) {
    return 35828;
  } else if (name.indexOf("s24+ 12/512 gray") != -1) {
    return 30992;
  } else if (name.indexOf("s24+ 12/512 onyx black") != -1) {
    return 30986;
  } else if (name.indexOf("s24+ 12/512 orange") != -1) {
    return 35778;
  } else if (name.indexOf("s24+ 12/512 yellow") != -1) {
    return 30988;
  } else if (name.indexOf("s24+ 12/512 violet") != -1) {
    return 30990;
  } else if (name.indexOf("s24+ 12/512 green") != -1) {
    return 35769;
  } else if (name.indexOf("s24+ 12/512 blue") != -1) {
    return 35829;
  } else if (
    name.indexOf("s24 8/128 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 8/128 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34341;
  } else if (
    name.indexOf("s24 8/128 yellow 🇪🇺") != -1 ||
    ...
    name.indexOf("s24 8/128 violet 🇰🇿") != -1 ||
    (name.indexOf("s24 8/128 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34339;
  } else if (
    name.indexOf("s24 8/128 violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 8/128 green 🇦🇪") != -1 ||
    (name.indexOf("s24 8/128 green") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/128 green") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35859;
  } else if (
    name.indexOf("s24 8/128 gray 🇰🇿") != -1 ||
    (name.indexOf("s24 8/128 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34336;
  } else if (
    name.indexOf("s24 8/128 grey 🇦🇪") != -1 ||
    name.indexOf("s24 8/128 gray 🇦🇪") != -1 ||
    (name.indexOf("s24 8/128 grey") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/128 grey") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 8/128 gray") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/128 gray") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 34368;
  } else if (
    ...
    name.indexOf("s24 8/128 orange 🇦🇪") != -1 ||
    (name.indexOf("s24 8/128 orange") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/128 orange") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35860;
  } else if (
    name.indexOf("s24 8/128 blue 🇦🇪") != -1 ||
    (name.indexOf("s24 8/128 blue") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/128 blue") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35861;
  } else if (
    name.indexOf("s24 8/256 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 8/256 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34344;
  } else if (
    name.indexOf("s24 8/256 yellow 🇪🇺") != -1 ||
    ...
    name.indexOf("s24 8/256 violet 🇰🇿") != -1 ||
    (name.indexOf("s24 8/256 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34338;
  } else if (
    name.indexOf("s24 8/256 violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 8/256 green 🇦🇪") != -1 ||
    (name.indexOf("s24 8/256 green") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/256 green") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35862;
  } else if (
    name.indexOf("s24 8/256 gray 🇰🇿") != -1 ||
    (name.indexOf("s24 8/256 gray") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34346;
  } else if (
    name.indexOf("s24 8/256 gray 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 8/256 orange 🇦🇪") != -1 ||
    (name.indexOf("s24 8/256 orange") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/256 orange") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35863;
  } else if (
    name.indexOf("s24 8/256 blue 🇦🇪") != -1 ||
    (name.indexOf("s24 8/256 blue") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/256 blue") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35864;
  } else if (
    name.indexOf("s24 8/512 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 8/512 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34340;
  } else if (
    name.indexOf("s24 8/512 yellow 🇪🇺") != -1 ||
    ...
    name.indexOf("s24 8/512 violet 🇰🇿") != -1 ||
    (name.indexOf("s24 8/512 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34337;
  } else if (
    name.indexOf("s24 8/512 violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 8/512 green 🇦🇪") != -1 ||
    (name.indexOf("s24 8/512 green") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/512 green") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35865;
  } else if (
    name.indexOf("s24 8/512 gray 🇰🇿") != -1 ||
    (name.indexOf("s24 8/512 gray") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34335;
  } else if (
    name.indexOf("s24 8/512 gray 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 8/512 orange 🇦🇪") != -1 ||
    (name.indexOf("s24 8/512 orange") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/512 orange") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35866;
  } else if (
    name.indexOf("s24 8/512 blue 🇦🇪") != -1 ||
    (name.indexOf("s24 8/512 blue") != -1 && name.indexOf("🇪🇺") != -1) ||
    (name.indexOf("s24 8/512 blue") != -1 && name.indexOf("🇦🇪") != -1)
  ) {
    return 35867;
  } else if (
    name.indexOf("s24 ultra 12/1tb blue 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/1tb blue") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/1tb blue") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35874;
  } else if (
    name.indexOf("s24 ultra 12/1tb green 🇪🇺") != -1 ||
    (name.indexOf("s24 ultra 12/1tb green") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/1tb green") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35875;
  } else if (
    name.indexOf("s24 ultra 12/1tb orange 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/1tb orange") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/1tb orange") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35876;
  } else if (
    name.indexOf("s24 ultra 12/256 blue 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/256 blue") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/256 blue") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35877;
  } else if (
    name.indexOf("s24 ultra 12/256 green 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/256 green") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/256 green") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35878;
  } else if (
    name.indexOf("s24 ultra 12/256 orange 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/256 orange") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/256 orange") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35879;
  } else if (
    name.indexOf("s24 ultra 12/512 blue 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/512 blue") != -1 && name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/512 blue") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35882;
  } else if (
    name.indexOf("s24 ultra 12/512 green 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/512 green") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/512 green") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35880;
  } else if (
    name.indexOf("s24 ultra 12/512 orange 🇦🇪") != -1 ||
    (name.indexOf("s24 ultra 12/512 orange") != -1 &&
      name.indexOf("🇦🇪") != -1) ||
    (name.indexOf("s24 ultra 12/512 orange") != -1 && name.indexOf("🇪🇺") != -1)
  ) {
    return 35881;
  } else if (
    name.indexOf("s24 ultra 12/1tb black 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb black") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34362;
  } else if (
    name.indexOf("s24 ultra 12/1tb black 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/1tb grey 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb grey") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34363;
  } else if (
    name.indexOf("s24 ultra 12/1tb grey 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/1tb violet 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34361;
  } else if (
    name.indexOf("s24 ultra 12/1tb violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/1tb yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/1tb yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34359;
  } else if (
    name.indexOf("s24 ultra 12/1tb yellow 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/256 black 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 black") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34366;
  } else if (
    name.indexOf("s24 ultra 12/256 black 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/256 grey 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 grey") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34364;
  } else if (
    name.indexOf("s24 ultra 12/256 grey 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/256 violet 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34355;
  } else if (
    name.indexOf("s24 ultra 12/256 violet 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/256 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/256 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34357;
  } else if (
    name.indexOf("s24 ultra 12/256 yellow 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/512 black 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 black") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34358;
  } else if (
    name.indexOf("s24 ultra 12/512 black 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/512 grey 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 grey") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34360;
  } else if (
    name.indexOf("s24 ultra 12/512 grey 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 ultra 12/512 violet 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 violet") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34365;
  } else if (
    name.indexOf("s24 ultra 12/512 violet 🇪🇺") != -1 ||
    ...
    name.indexOf("s24 ultra 12/512 yellow 🇰🇿") != -1 ||
    (name.indexOf("s24 ultra 12/512 yellow") != -1 && name.indexOf("🇰🇿") != -1)
  ) {
    return 34356;
  } else if (
    name.indexOf("s24 ultra 12/512 yellow 🇦🇪") != -1 ||
    ...
    name.indexOf("s24 12/256 black") != -1 ||
    name.indexOf("s24 12/256 blaсk") != -1
  ) {
    return 36043;
  } else if (name.indexOf("s24 12/256 orange") != -1) {
    return 36044;
    ...
    return 36046;
  } else if (name.indexOf("s24 8/128 yellow") != -1) {
    return 30976;
  } else if (name.indexOf("s24 8/128 violet") != -1) {
    return 30979;
  } else if (name.indexOf("s24 8/128 green") != -1) {
    return 35749;
  } else if (name.indexOf("s24 8/128 gray") != -1) {
    return 30982;
  } else if (name.indexOf("s24 8/128 black") != -1) {
    return 30973;
  } else if (name.indexOf("s24 8/128 orange") != -1) {
    return 35774;
  } else if (name.indexOf("s24 8/128 blue") != -1) {
    return 35825;
  } else if (name.indexOf("s24 8/256 yellow") != -1) {
    return 30977;
  } else if (name.indexOf("s24 8/256 violet") != -1) {
    return 30980;
  } else if (name.indexOf("s24 8/256 green") != -1) {
    return 35752;
  } else if (name.indexOf("s24 8/256 gray") != -1) {
    return 30983;
  } else if (name.indexOf("s24 8/256 black") != -1) {
    return 30974;
  } else if (name.indexOf("s24 8/256 orange") != -1) {
    return 35775;
  } else if (name.indexOf("s24 8/256 blue") != -1) {
    return 35826;
  } else if (name.indexOf("s24 8/512 yellow") != -1) {
    return 30978;
  } else if (name.indexOf("s24 8/512 violet") != -1) {
    return 30981;
  } else if (name.indexOf("s24 8/512 green") != -1) {
    return 35767;
  } else if (
    name.indexOf("s24 8/512 grey") != -1 ||
    name.indexOf("s24 8/512 gray") != -1
  ) {
    return 30984;
  } else if (name.indexOf("s24 8/512 black") != -1) {
    return 30975;
  } else if (name.indexOf("s24 8/512 orange") != -1) {
    return 35776;
    ...
    return 30992;
  } else if (name.indexOf("s24+ 12/512 black") != -1) {
    return 30986;
  } else if (name.indexOf("s24+ 12/512 orange") != -1) {
    return 35778;
  } else if (name.indexOf("s24+ 12/512 yellow") != -1) {
    ...
    return 30991;
  } else if (name.indexOf("s24+ 12/256 black") != -1) {
    return 30985;
  } else if (name.indexOf("s24+ 12/256 orange") != -1) {
    return 35777;
  } else if (name.indexOf("s23+ 8/256 cream") != -1) {
    ...
    return 30997;
  } else if (name.indexOf("s24 ultra 12/256 yellow") != -1) {
    return 30993;
  } else if (name.indexOf("s24 ultra 12/512 black") != -1) {
    return 31004;
  } else if (name.indexOf("s24 ultra 12/512 blue") != -1) {
    return 35834;
  } else if (name.indexOf("s24 ultra 12/256 gray") != -1) {
    return 31000;
  } else if (name.indexOf("s24 ultra 12/256 orange") != -1) {
    return 35783;
  } else if (name.indexOf("s24 ultra 12/256 green") != -1) {
    return 35780;
  } else if (name.indexOf("s24 ultra 12/1tb violet") != -1) {
    return 30996;
  } else if (name.indexOf("s24 ultra 12/1tb yellow") != -1) {
    return 30995;
  } else if (name.indexOf("s24 ultra 12/256 black") != -1) {
    return 31003;
  } else if (name.indexOf("s24 ultra 12/256 blue") != -1) {
    return 35833;
  } else if (name.indexOf("s24 ultra 12/1tb gray") != -1) {
    return 30999;
  } else if (name.indexOf("s24 ultra 12/1tb orange") != -1) {
    return 35782;
  } else if (name.indexOf("s24 ultra 12/1tb green") != -1) {
    return 35779;
  } else if (name.indexOf("s24 ultra 12/512 violet") != -1) {
    return 30998;
  } else if (name.indexOf("s24 ultra 12/512 yellow") != -1) {
    return 30994;
  } else if (
    name.indexOf("s24 ultra 12/512 orange") != -1 ||
    name.indexOf("s24 ultra 12/512 orange") != -1
    ...
    return 31000;
  } else if (name.indexOf("s24 ultra 12/512 gray") != -1) {
    return 31001;
    ...
    name.indexOf("tab a9 4/64 lte graphite") != -1 ||
    ...
    name.indexOf("tab a9 4/64 lte navy") != -1 ||
    ...
    name.indexOf("tab a9 4/64 lte silver") != -1 ||
    ...
    name.indexOf("tab a9 8/128 lte graphite") != -1 ||
    ...
    name.indexOf("tab a9 8/128 lte navy") != -1 ||
    ...
    name.indexOf("tab a9 8/128 lte silver") != -1 ||
    ...
    name.indexOf("tab s9 8/128 wi-fi beige") != -1 ||
    name.indexOf("tab s9 8/128 beige") != -1
  ) {
    return 27925;
  } else if (
    name.indexOf("tab s9 8/128 wi-fi graphite") != -1 ||
    name.indexOf("tab s9 8/128 graphite") != -1
  ) {
    return 27926;
  } else if (
    name.indexOf("tab s9 fe 6/128 wi-fi gray") != -1 ||
    name.indexOf("tab s9 fe 6/128 gray") != -1
  ) {
    return 30146;
  } else if (
    name.indexOf("tab s9 fe 6/128 wi-fi lavender") != -1 ||
    name.indexOf("tab s9 fe 6/128 lavender") != -1
  ) {
    return 30148;
  } else if (
    ...
    name.indexOf("tab s9 fe 8/256 wi-fi lavender") != -1 ||
    name.indexOf("tab s9 fe 8/256 lavender") != -1
  ) {
    return 30149;
  } else if (
    ...
    name.indexOf("tab s9 fe 8/256 wi-fi silver") != -1 ||
    name.indexOf("tab s9 fe 8/256 silver") != -1
  ) {
    return 30145;
  } else if (
    ...
    name.indexOf("tab s9 ultra 12/256 wi-fi graphite") != -1 ||
    name.indexOf("tab s9 ultra 12/256 graphite") != -1
  ) {
    return 27936;
  } else if (
    name.indexOf("tab s9 ultra 12/512 wi-fi beige") != -1 ||
    name.indexOf("tab s9 ultra 12/512 beige") != -1
  ) {
    return 27934;
  } else if (
    name.indexOf("tab s9 ultra 12/512 wi-fi graphite") != -1 ||
    name.indexOf("tab s9 ultra 12/512 graphite") != -1
  ) {
    return 27937;
  } else if (
    name.indexOf("tab s9 ultra 16/1tb wi-fi beige") != -1 ||
    name.indexOf("tab s9 ultra 16/1tb beige") != -1
  ) {
    return 27935;
  } else if (
    name.indexOf("tab s9 ultra 16/1tb wi-fi graphite") != -1 ||
    name.indexOf("tab s9 ultra 16/1tb graphite") != -1
  ) {
    return 27938;
  } else if (
    ...
    name.indexOf("tab s9 fe 128 graphite") != -1
  ) {
    return 30146;
  } else if (
    ...
    name.indexOf("tab s9 fe 256 graphite") != -1
  ) {
    return 30147;
  } else if (
    ...
    name.indexOf("galaxy watch6 classic 43 graphite") != -1 ||
    name.indexOf("galaxy watch 6 classic 43 graphite") != -1 ||
    ...
    name.indexOf("galaxy watch 6 classic 47 graphite") != -1 ||
    name.indexOf("galaxy watch 6 classic 47 black") != -1
  ) {
    return 27920;
  } else if (name.indexOf("galaxy watch6 classic 47 silver") != -1) {
    return 27919;
