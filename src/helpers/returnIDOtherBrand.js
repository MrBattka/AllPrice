...
export const returnIDOtherBrand = (name) => {
  if (name.indexOf("rog ally 16/256 white") != -1) {
    ...
    return 23970;
  } else if (name.indexOf("pixel 7a 128 charcoal") != -1) {
    return 27902;
    ...
    name.indexOf("pixel 8 128 rose") != -1 ||
    name.indexOf("pixel 8 128 pink") != -1
  ) {
    return 30271;
    ...
    return 30277;
  } else if (name.indexOf("pixel 8 pro 1tb (1024) bay") != -1) {
    return 30282;
  } else if (name.indexOf("pixel 8 pro 1tb (1024) obsidian") != -1) {
    return 30276;
  } else if (name.indexOf("pixel 8 pro 1tb (1024) porcelain") != -1) {
    return 30278;
    ...
    // PlayStation
  } else if (name.indexOf("ps5 slim disc edition") != -1) {
    return 30947;
    ...
    return 28510;
  } else if (name.indexOf("redmagic 9 pro 12/256 sleet") != -1) {
    return 34469;
  } else if (name.indexOf("redmagic 9 pro 16/512 cyclone") != -1) {
    return 34471;
  } else if (name.indexOf("redmagic 9 pro 16/512 snowfall") != -1) {
    return 34470;
